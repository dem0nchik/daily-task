...
import { showAuth, postUser, chekME } from '../actions/userActions';
        ...
        return (
            <div className='header'>
                { this.props.user.name ? 
                    ...
                    <ul>
                        <li title='linkedIn'>
                            <a href='https://www.linkedin.com/in/dima-budyk-6a7876150/' target='_blank'>
                                <svg version="1.1" width="20" height="20" viewBox="0 0 512 512"><g></g>
                        ...
                        <li title='github'>
                            <a href='https://github.com/dem0nchik' target='_blank'>
                                <svg version="1.1" width="20" height="20" viewBox="0 0 438.549 438.549" > <g>
